    ...
    <div className="min-h-screen bg-[#0d1117] flex flex-col">
      ...
      <nav className="flex items-center justify-between px-6 py-5 max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold">L</div>
          <span className="text-xl font-bold text-white tracking-tight">LENDANET</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="text-sm font-bold text-slate-700 px-4 py-2 hover:bg-[#1c2128] rounded-xl transition-all"
          >
            Login
          </button>
      ...
      <section className="relative px-6 pt-16 pb-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] tracking-tight mb-8">
            The Shared Default <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-600">Intelligence</span> Network
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <button 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold text-lg shadow-xl shadow-slate-900/20 hover:bg-slate-800 active:scale-95 transition-all flex items-center justify-center gap-2"
            >
              Start for Free <ArrowRight size={20} />
            </button>
            <button 
              onClick={() => navigate('/login')}
              className="w-full sm:w-auto px-8 py-4 bg-[#161b22] text-slate-700 border border-[#30363d] rounded-2xl font-bold text-lg hover:bg-slate-50 active:scale-95 transition-all shadow-sm"
            >
              Demo Access
            </button>
          </div>
      ...
      {/* Featured Section */}
      <section id="features" className="bg-[#161b22] py-24 px-6 border-y border-[#30363d]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Protect Your Capital</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-[#0d1117] border border-[#30363d] hover:border-blue-200 hover:bg-[#1c2128] hover:shadow-xl transition-all cursor-default group">
      ...
      <section className="py-24 px-6 bg-slate-900 text-white text-center">
        <div className="max-w-3xl mx-auto">
          <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-8 text-3xl font-bold">"</div>
          <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-tight">
            "LendaNet has reduced my default rate by 40% in just three months. I never lend without searching first."
          </h2>
          <p className="text-blue-400 font-bold uppercase tracking-wider text-sm">John Kapambwe — Independent Lender</p>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-[#0d1117] py-12 px-6 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold text-xs">L</div>
            <span className="text-lg font-bold text-white tracking-tight">LENDANET</span>
          </div>
