  ...
  return (
    <div className="min-h-screen bg-[#161b22] md:bg-[#0d1117] flex flex-col font-sans relative overflow-x-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute top-1/2 -left-32 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 px-5 pt-8 pb-4 flex items-center justify-between max-w-2xl mx-auto w-full">
        ...
        <div className="flex items-center gap-2">
           ...
           <span className="text-sm font-bold tracking-tight text-white uppercase">Lendan<span className="text-blue-600">et</span></span>
        </div>
        <div className="w-10" />
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-5 pb-10">
        <div className="w-full max-w-[400px]">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-white tracking-tight leading-none mb-2">Verify Account</h2>
          ...
          <form onSubmit={handleVerify} className="space-y-8">
            <div className="flex gap-2.5 justify-center">
              {otp.map((digit, idx) => (
                <input
                  ...
                  className="w-11 h-14 sm:w-14 sm:h-16 text-center text-xl font-bold bg-[#161b22] border border-gray-100 rounded-2xl shadow-sm
                    focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 focus:bg-[#1c2128] transition-all outline-none"
                />
              ))}
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 text-center">
                <button type="button" className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-wider transition-colors group">
          ...
          <div className="mt-12 p-5 bg-blue-50/50 rounded-3xl border border-blue-100/50">
            <p className="text-[10px] text-blue-800/60 font-bold text-center leading-relaxed uppercase tracking-wider">
