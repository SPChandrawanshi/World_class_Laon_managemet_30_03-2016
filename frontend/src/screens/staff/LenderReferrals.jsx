...
export default function LenderReferrals() {
  ...
  useEffect(() => {
    if (user?.id) {
      const s = referralService.getReferralStats(user.id);
      setStats(s);
    }
  }, [user]);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      >
        ...
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-64 h-64 bg-[#161b22]/10 rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#161b22]/20 backdrop-blur-md text-[10px] font-bold uppercase tracking-wider">
              <Gift size={12} />
              Referral Program
            </div>
            <h1 className="text-3xl font-bold tracking-tight">Invite Lenders, Earn Rewards</h1>
          ...
          <div className="bg-[#161b22]/15 backdrop-blur-xl border border-white/20 rounded-2xl p-5 flex flex-col items-center justify-center text-center min-w-[180px]">
            <p className="text-[10px] uppercase font-bold text-blue-200 tracking-wider mb-1">Total Earned</p>
            <p className="text-4xl font-bold">K{stats.totalEarned}</p>
      ...
      {/* Referral Link Card */}
      <div className="bg-[#161b22] rounded-3xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <div className="flex-1 flex items-center gap-3 px-4 py-3 bg-[#0d1117] border border-gray-100 rounded-2xl group transition-all hover:bg-[#1c2128] hover:border-blue-100">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="bg-[#161b22] rounded-3xl p-5 shadow-sm border border-gray-100 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          {[
            ...
            <div key={i} className="space-y-2">
              <span className="text-2xl font-bold text-blue-500/50 block">{s.step}</span>
      ...
      {/* Progress Section */}
      <div className="bg-[#161b22] rounded-3xl overflow-hidden shadow-sm border border-gray-100">
        <div className="px-6 py-5 border-b border-gray-50 flex items-center justify-between">
          <h2 className="text-sm font-bold text-white">Recent Referrals</h2>
          <button className="text-[10px] font-bold text-blue-600 uppercase tracking-wider hover:text-blue-700">View All</button>
        </div>
            ...
            <div key={i} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
              ...
              <div className="flex items-center gap-6">
                <div className="text-right hidden sm:block">
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Borrowers</p>
                  <p className="text-xs font-bold text-gray-700">{r.borrowers}</p>
                </div>
                ...
                <div className="text-right">
                  ...
                  <p className="mt-1 text-xs font-bold text-white">{r.amount}</p>
                </div>
