      ...
      <Modal isOpen={editModal} onClose={() => setEditModal(false)} title="Edit Profile">
        <div className="space-y-4">
          ...
          <div className="pt-4 border-t border-gray-100">
            <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-4 px-1">Update Password</h4>
        ...
        <div className="flex gap-3 mt-8">
          ...
          }}><Edit3 size={14}/> Save Changes</Btn>
        </div>
      </Modal>


      {/* ID Proof Upload Section */}
      <div className="bg-[#161b22] rounded-2xl border border-gray-100 shadow-sm p-3 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-0.5">
            <h3 className="text-[10px] font-bold text-gray-800 uppercase tracking-wider">ID Proof</h3>
        ...
        <label className="flex items-center justify-center gap-1.5 px-3 py-1.5 border border-dashed border-gray-300 rounded-lg bg-[#0d1117] cursor-pointer hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-colors text-gray-600 font-bold text-[10px] uppercase">
          <Upload size={12} />
          Upload
