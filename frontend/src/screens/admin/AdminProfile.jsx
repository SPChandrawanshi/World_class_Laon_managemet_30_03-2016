...
export default function AdminProfile() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-[#161b22] rounded-[32px] border border-gray-100 shadow-sm overflow-hidden p-6 relative">
        ...
        <div className="text-center">
          <div className="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-2xl mx-auto mb-3 border-4 border-blue-50/50">
            {user?.initials || 'AU'}
          </div>
          <h2 className="text-xl font-bold text-white tracking-tight">{user?.name}</h2>
          <p className="text-blue-600 font-bold text-[11px] uppercase tracking-wider leading-none mt-1">System Administrator</p>
        </div>
        ...
        <div className="mt-6 space-y-2 text-left max-w-sm mx-auto">
          {[
            ...
            <div key={label} className="flex items-center gap-3 p-3.5 bg-[#0d1117]/50 rounded-2xl border border-gray-100/50">
              <div className="w-9 h-9 rounded-xl bg-[#161b22] flex items-center justify-center shadow-sm">
        ...
        <button
          ...
          className="mt-6 flex items-center justify-center gap-2 w-full max-w-sm mx-auto py-3.5 rounded-2xl bg-red-50 text-red-600 text-xs font-bold uppercase tracking-wider hover:bg-red-100 transition-all active:scale-95"
        >
          <LogOut size={16} />
          Sign Out
        </button>
